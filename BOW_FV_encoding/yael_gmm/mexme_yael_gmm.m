function mexme_yael_gmm(options)

%
%
% Compile each mex-files of the yael Kmeans package
%
%  Usage
%  ------
%
%  mexme_yael_gmm([options])
%
%  Inputs
%  -------
%
...
%  mexme_yael_gmm(options);
%
%  Example3 (with Intel Compiler 12 & Windows 64)
%  -------
%
%  options.useOMP      = 1;
%  options.userBLAS    = '"C:\Program Files (x86)\Intel\Composer XE 2011 SP1\mkl\lib\intel64\mkl_core.lib" "C:\Program Files (x86)\Intel\Composer XE 2011 SP1\mkl\lib\intel64\mkl_intel_lp64.lib" "C:\Program Files (x86)\Intel\Composer XE 2011 SP1\mkl\lib\intel64\mkl_intel_thread.lib"';
%  mexme_yael_gmm(options);
...
files1  = {'ndellipse' , 'denseSIFT'};
files2  = {'yael_gmm' , 'yael_proba_gmm' , 'yael_fisher_gmm' , 'yael_fisher_gmm_ori'};
files3  = {'sample_mvgm.c -DranSHR3'};
...
%         end
    ...
    if(~isempty(exception))
        fprintf(['\n Error during compilation, be sure to:\n'...
            ...
            'ii) You did "mex -setup" in matlab prompt before running mexme_yeal_gmm\n']);
    end
end
